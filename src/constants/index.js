...
import projects6 from "../assets/projects6.jpeg";
...
export const HERO_CONTENT = {
  ...
  introduction:
    "I’m Mike Jason, a creative frontend, crafting immersive and intuitive web apps.",
  description:
    "I’m currently helping businesses bring their visions to life through interactive digital solutions.",
  resumeLinkText: "Download Resume",
  resumeLink: "/mike-jason-resume.pdf",
};
...
export const CONTACT_CONTENT = {
  ...
  footerText: `© ${new Date().getFullYear()} BHCode (Hanna Bykouskaya). All rights reserved.`,
};
